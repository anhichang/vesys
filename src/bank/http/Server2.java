...
public class Server2 {
	...
	static class BankHandler implements HttpHandler {
		...
		public static String allUsersPage() throws IOException {
			...
			for (String name : accountNumbers) {
				buf.append(String.format(
						"<tr><td width=300>" + "<a href=" + "/startbank?cmd=showuser&parameter1="
		...
		public static String createUsersPage() {
			...
			buf.append(
					"<TR><TD>Amount:</TD><TD><input size=40 maxlength=40 type='number' step=0.01 name='parameter2'></TD></TR>");
			buf.append("</TABLE>");
			buf.append("<p>");
		...
		public static String showUserPage(String id) throws IOException {
			...
			buf.append(
					"<TR><TD><b>Amount:</b></TD><TD><input size=40 maxlength=40 type='number' step=0.01 name='parameter2'></TD></TR>");
			buf.append("</TABLE>");
			...
			buf.append("<input name='parameter1'" + "value=" + "'" + id + "'" + "hidden>");
			buf.append(
					"<TR><TD><b>Withdraw:</b></TD><TD><input size=40 maxlength=40 type='number' step=0.01 name='parameter2'></TD></TR>");
			buf.append("</TABLE>");
