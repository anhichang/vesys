 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://server.soap.bank/", wsdlLocation = "http://localhost:9876/bank?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://server.soap.bank/", "ServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9876/bank?wsdl");
    ...
    public ServiceImpl getServiceImplPort() {
        return super.getPort(new QName("http://server.soap.bank/", "ServiceImplPort"), ServiceImpl.class);
    }
    ...
    public ServiceImpl getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.bank/", "ServiceImplPort"), ServiceImpl.class, features);
    }
